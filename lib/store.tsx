...
const SEED_DISTRIBUTIONS: Distribution[] = [
  {
    id: "SAP-2025-Q1", title: "SAP 2025 — Una", barangay: "Sta. Cruz, Quezon City",
    scheduledDate: "2025-03-15", amount: 1500, status: "ACTIVE",
    totalBeneficiaries: 5, totalClaimed: 4, disbursementMethod: "Mixed",
    createdBy: "LGU Admin", createdAt: "2025-03-01T08:00:00Z"
  },
]

const SEED_CLAIMS: Claim[] = [
  {
    id: "CLM-001", beneficiaryId: "VF-2025-0001-STC", beneficiaryName: "Maria Santos dela Cruz",
    distributionId: "SAP-2025-Q1", distributionTitle: "SAP 2025 — Una", amount: 1500,
    method: "Cash", status: "NAKUHA", verifiedBy: "Josefa Reyes",
    verifiedAt: "2025-03-15T09:14:00Z", barangay: "Sta. Cruz, Quezon City"
  },
  {
    id: "CLM-002", beneficiaryId: "VF-2025-0099-STC", beneficiaryName: "Juan Reyes Bautista",
    distributionId: "SAP-2025-Q1", distributionTitle: "SAP 2025 — Una", amount: 1500,
    method: "GCash", status: "NAKUHA", verifiedBy: "Josefa Reyes",
    verifiedAt: "2025-03-15T09:22:00Z", barangay: "Sta. Cruz, Quezon City"
  },
  {
    ...
    verifiedBy: "Josefa Reyes", verifiedAt: "2025-03-15T09:41:00Z",
...
const SEED_AUDIT: AuditEntry[] = [
  {
    ...
    actorName: "Josefa Reyes", actorRole: "OFFICER",
    targetId: "VF-2025-0001-STC", targetName: "Maria Santos dela Cruz",
    barangay: "Sta. Cruz, Quezon City", details: "Claim confirmed — SAP 2025 Q1 — ₱1,500 Cash"
  },
  {
    id: "AUD-002", timestamp: "2025-03-15T09:22:00Z", action: "CLAIMED",
    actorName: "Josefa Reyes", actorRole: "OFFICER",
    targetId: "VF-2025-0099-STC", targetName: "Juan Reyes Bautista",
    barangay: "Sta. Cruz, Quezon City", details: "Claim confirmed — SAP 2025 Q1 — ₱1,500 GCash"
  },
  {
    ...
    barangay: "Sta. Cruz, Quezon City", details: "Velocity anomaly — duplicate claim attempt blocked"
  },
]
