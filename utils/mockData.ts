...
export function initializeStorage() {
  const beneficiaries = localStorage.getItem(BENEFICIARIES_KEY);
  const transactions = localStorage.getItem(TRANSACTIONS_KEY);

  if (!beneficiaries) {
    localStorage.setItem(
      BENEFICIARIES_KEY,
      JSON.stringify(INITIAL_BENEFICIARIES),
    );
  }
...
const INITIAL_BENEFICIARIES: Beneficiary[] = [
  ...
  },
  {
    ...
    status: "Ready",
    photoUrl:
      "https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80",
    liveFeedUrl:
      "https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80",
    details: {
  ...
  },
  {
    ...
    liveFeedUrl:
      "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80", // Identical to simulate deepfake/spoof
    details: {
  ...
  },
  {
    ...
    status: "Ready",
    photoUrl:
      "https://images.unsplash.com/photo-1554151228-14d9def656ec?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80",
    liveFeedUrl:
      "https://images.unsplash.com/photo-1554151228-14d9def656ec?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80",
    details: {
  ...
  },
  {
    ...
    liveFeedUrl:
      "https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80", // Different person
    details: {
...
export const saveBeneficiaries = (data: Beneficiary[]) => {
  localStorage.setItem(BENEFICIARIES_KEY, JSON.stringify(data));
};
